...
<template>
    <div class="taskDetail-container">
        ...
        <div style="margin-bottom: 30px; font-size: 18px;" @click="$router.back()">
                ...
                >
                    <template slot-scope="scope">
                        <span
                            ...
                            style="color: #6e96e9; cursor: pointer"
                            >下载</span
                        >
                    </template>
                </el-table-column>
...
export default {
    ...
    methods: {
        initDetail() {
            ...
            this.api.detail.all(term).then((res) => {
                if (res.data.success == true) {
                    console.log("打印详情数据", res.data);
